...
{
    partial class CikisCarileriSorgula
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.cariCikisKontrolCekleriBindingSource = new System.Windows.Forms.BindingSource(this.components);
            ...
            this.cariCikisKontrolCekleriTableAdapter = new FistasCekDuzenleme.DsTableAdapters.CariCikisKontrolCekleriTableAdapter();
            this.panel1.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)(this.grdCari)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.cariCikisKontrolCekleriBindingSource)).BeginInit();
            ...
            // grdCari
            // 
            this.grdCari.DataSource = this.cariCikisKontrolCekleriBindingSource;
            ...
            this.grdCari.TabIndex = 22;
            this.grdCari.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.gridView1});
            // 
            // cariCikisKontrolCekleriBindingSource
            // 
            this.cariCikisKontrolCekleriBindingSource.DataMember = "CariCikisKontrolCekleri";
            this.cariCikisKontrolCekleriBindingSource.DataSource = this.ds;
            // 
            // ds
            // 
            ...
            this.colVadeTarihi.VisibleIndex = 6;
            ...
            this.colDovizCinsi.VisibleIndex = 8;
            this.colDovizCinsi.Width = 100;
            // 
            // colDovizKuru
            // 
            ...
            this.colDovizKuru.VisibleIndex = 9;
            this.colDovizKuru.Width = 103;
            // 
            // colDovizTutari
            // 
            ...
            this.colDovizTutari.FieldName = "YeniDoviz";
            this.colDovizTutari.Name = "colDovizTutari";
            this.colDovizTutari.OptionsColumn.ReadOnly = true;
            this.colDovizTutari.Visible = true;
            this.colDovizTutari.VisibleIndex = 10;
            this.colDovizTutari.Width = 110;
            // 
            // cariCikisKontrolCekleriTableAdapter
            // 
            this.cariCikisKontrolCekleriTableAdapter.ClearBeforeFill = true;
            // 
            // CikisCarileriSorgula
            // 
            ...
            this.Name = "CikisCarileriSorgula";
            this.Text = "Alacak Çekleri Çıkış İşlemleri";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.CikisCarileriSorgula_FormClosing);
            this.Load += new System.EventHandler(this.CikisCarileriSorgula_Load);
            this.panel1.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)(this.grdCari)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.cariCikisKontrolCekleriBindingSource)).EndInit();
        ...
        private Ds ds;
        private System.Windows.Forms.BindingSource cariCikisKontrolCekleriBindingSource;
        private DsTableAdapters.CariCikisKontrolCekleriTableAdapter cariCikisKontrolCekleriTableAdapter;
    }
}